...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white text-gray-800">
      <h1 className="text-3xl font-semibold text-left mb-6">Privacy Policy</h1>
      <p className="mb-6 text-lg text-left">
        This Privacy Policy is a part of our Terms and Conditions. By using this Website or our online store, you agree to be bound by and comply with this Privacy Policy and our Terms and Conditions.
      </p>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Section 1 - Age restrictions on access and purchases</h2>
        ...
        <p className="text-lg mb-4">
          If we learn we have collected or received personal information from a person under the age of 21 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a person under the age of 21, please contact us at: <a href="mailto:contact@buzzhubapp.com" className="text-blue-500">buzzhubapp.com</a>
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Section 2 - What information do we gather and what do we do with it?</h2>
        <p className="text-lg mb-4">
          When you purchase something from our online store, as part of the buying and selling process, we collect the personal information you give us such as your name, address, email address, and order history. We also use cookies, web beacons, or other tools that collect information that make it easier to use our store and our site.
        </p>
        <p className="text-lg mb-4">
        ...
        <ul className="list-disc pl-8 text-lg mb-4">
          <li>Facilitate the creation and securing of your Account on our network;</li>
          ...
          <li>Communicate with you about promotions, upcoming events, and news about products and services offered by BuzzHub Group, LLC;</li>
        ...
        <p className="text-lg">
          California Privacy Rights: If you are a California resident, California law may provide you with additional rights regarding the use of your personal information. To learn more about your California privacy rights, visit this page.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Section 3 - Behavioral advertising</h2>
        <p className="text-lg mb-4">
          As described above, we use your Personal Information to provide you with targeted advertisements or marketing communications we believe may be of interest to you. For example:
        </p>
        <ul className="list-disc pl-8 text-lg mb-4">
          <li>We use Google Analytics to help us understand how our customers use the Site. You can read more about how Google uses your Personal Information <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank" className="text-blue-500">here</a>. You can also opt-out of Google Analytics <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" className="text-blue-500">here</a>.</li>
        ...
        <p className="text-lg mb-4">
          For more information about how targeted advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational page at: <a href="https://www.networkadvertising.org/understanding-online-advertising/how-does-it-work" target="_blank" className="text-blue-500">NAI Educational Page</a>.
        </p>
        <p className="text-lg">
          You can opt out of targeted advertising by:
        </p>
        <ul className="list-disc pl-8 text-lg mb-4">
          <li>FACEBOOK - <a href="https://www.facebook.com/settings/?tab=ads" target="_blank" className="text-blue-500">Facebook Settings</a></li>
          <li>GOOGLE - <a href="https://www.google.com/settings/ads/anonymous" target="_blank" className="text-blue-500">Google Settings</a></li>
          <li>BING - <a href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads" target="_blank" className="text-blue-500">Bing Ads Settings</a></li>
          <li>Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out portal at: <a href="https://optout.aboutads.info/" target="_blank" className="text-blue-500">DAA Opt-Out Portal</a>.</li>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Section 4 - More information on cookies</h2>
        <p className="text-lg mb-4">
        ...
        <p className="text-lg mb-4">
          Most browsers automatically accept cookies, but you can choose whether or not to accept cookies through your browser controls. For more information, please visit: <a href="http://www.allaboutcookies.org" className="text-blue-500">All About Cookies</a>.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg mb-4">
          By executing a transaction, and any time you provide us with personal information for the purpose of completing a transaction, placing an order, or arranging for a delivery or return of a purchase, you consent to us collecting and using your information as described herein.
        </p>
        <p className="text-lg mb-4">
          <strong>2) How do I withdraw my consent?</strong>
        </p>
        <p className="text-lg mb-4">
          You may withdraw your consent for us to use your personal information and from receiving email communications by clicking the “Unsubscribe” button included at the bottom of each email or contacting us at: <a href="mailto:contact@buzzhubapp.com" className="text-blue-500">contact@buzzhubapp.com</a>
        </p>
      </section>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Section 7 - Payment processing</h2>
        <p className="text-lg">
          Our store is built on an e-commerce software platform that allows us to sell our products and services to you.
        </p>
        <p className="text-lg mb-4">
          Payment: If you provide us with your credit card information during the payment process, we send it to our PCI-DSS compliant payment gateway for processing using SSL encryption technology. Your credit card information is never stored for use beyond the transaction for which it was supplied.
        </p>
        <p className="text-lg mb-4">
