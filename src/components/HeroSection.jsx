  ...
  return (
    ...
    >
      ...
      <div className="text-center pt-10" id="home"> 
        ...
        <h1 className="text-xl font-bold mt-4">The creators of Buzzhub have been hard at work to create a solution <br/> where all your weed needs can be met on one app</h1>
        <p className="text-xl  mt-2">No longer are you forced into an endless search for the best price, strain, or desired effects.</p>
